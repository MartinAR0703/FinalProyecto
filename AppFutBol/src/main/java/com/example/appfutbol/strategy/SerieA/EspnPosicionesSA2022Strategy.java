package com.example.appfutbol.strategy.SerieA;
...
public class EspnPosicionesSA2022Strategy implements ScrapingStrategy {
    private final String url= "https://www.espn.com.mx/futbol/posiciones/_/liga/ITA.1/temporada/2021";//serie A 2021-2022

    @Override
    public void execute() {
        try {
            System.out.println("Scrapeando La tabla de posiciones de la Serie A 2021-2022...");
