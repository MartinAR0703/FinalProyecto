...
public class EspnPosicionesBU2023Strategy implements ScrapingStrategy {
    private final String url= "https://www.espn.com.mx/futbol/posiciones/_/liga/GER.1/temporada/2023"; //Bundesliga 2023-2024

    @Override
    public void execute() {
        try {
            System.out.println("Scrapeando La tabla de posiciones de BundesLiga 2023-2024...");
