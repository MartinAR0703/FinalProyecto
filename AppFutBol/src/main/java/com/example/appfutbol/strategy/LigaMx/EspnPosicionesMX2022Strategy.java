package com.example.appfutbol.strategy.LigaMx;
...
public class EspnPosicionesMX2022Strategy implements ScrapingStrategy {
    private final String url= "https://www.espn.com.mx/futbol/posiciones/_/liga/MEX.1/tipodetemporada/1/temporada/2022"; //LigaMX 2021-2022

    @Override
    public void execute() {
        try {
            System.out.println("Scrapeando La tabla de posiciones de 2022...");
