...
public class EspnPosicionesMX2023Strategy implements ScrapingStrategy {
    private final String url= "https://www.espn.com.mx/futbol/posiciones/_/liga/MEX.1/temporada/2023"; //ligaMX 2023-2024

    @Override
    public void execute() {
        try {
            System.out.println("Scrapeando La tabla de posiciones de 2023-2024...");
