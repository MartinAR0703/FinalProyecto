...
public class EspnJugadorMX2022Strategy implements ScrapingStrategy {
    private final String url= "https://www.espn.com.mx/futbol/estadisticas/_/liga/MEX.1/temporada/2022/vista/anotaciones/equipo";

    @Override
    public void execute() {
        try {
            System.out.println("Scrapeando mejores jugadores de Liga MX 2022");
