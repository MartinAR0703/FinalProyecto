...
public class EspnPosicionesSA2023Strategy implements ScrapingStrategy {
    private final String url= "https://www.espn.com.mx/futbol/posiciones/_/liga/ITA.1/temporada/2022";//2022-2023

    @Override
    public void execute() {
        try {
            System.out.println("Scrapeando La tabla de posiciones de la Serie A 2022-2023...");
