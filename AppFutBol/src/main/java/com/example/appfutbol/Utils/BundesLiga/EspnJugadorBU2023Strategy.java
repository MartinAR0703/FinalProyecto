...
public class EspnJugadorBU2023Strategy implements ScrapingStrategy {
    private final String url= "https://www.espn.com.mx/futbol/estadisticas/_/liga/GER.1/temporada/2023/vista/anotaciones/equipo";

    @Override
    public List<Jugador> execute() {
        List<Jugador> jugadores = new ArrayList<>();
        try {
            System.out.println("Scrapeando mejores jugadores de BundesLiga 2023");
